...
simulationOutputC1<- updateFunction (Iterations, FinalA, N, contamVec, r, gamma)
...
FinalA <- createInitialAMat (N,Place,probVec)
simulationOutputC2<- updateFunction (Iterations, FinalA, N, contamVec, r, gamma)
...
FinalA <- createInitialAMat (N,Place,probVec)
simulationOutputC3<- updateFunction (Iterations, FinalA, N, contamVec, r, gamma)
